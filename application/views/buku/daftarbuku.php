                ...
                <?php foreach ($bukus as $buku) { ?>
                    <div class="col-md-2 col-md-3 mb-5 pb-2">
                        <div class="thumbnail" style="height: 370px;">
                            ...
                            <div class="caption">
                                <h6 style="min-height:30px; margin-top:10px;"><?= $buku->judul_buku ?></h6>
                                ...
                                <p>
                                    <?php
                                    if ($buku->stok < 1) {
                                        echo "<i class='btn btn-outline-primary'> Booking&nbsp;&nbsp 0</i>";
                                    } else {
                                        echo "<a class='btn btn-outline-primary' href='" . base_url('booking/tambahBooking/' . $buku->id) . "'> Booking</a>";
                                    }
                                    ?>
                                    <a class="btn btn-outline-warning" href="<?= base_url('home/detailBuku/' . $buku->id); ?>"> Detail</a>
                                </p>
                            </div>
                        </div>
                    </div> <?php } ?>
